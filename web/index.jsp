        ...
        <div class="card shadow-sm border-0" style="max-width: 400px; width: 100%; border-radius: 12px;">
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center small text-muted">
                    Belum punya akun? <a href="${pageContext.request.contextPath}/auth?registration"
                                         class="text-primary text-decoration-none fw-bold">Daftar di sini</a>
                </div>
