...
<%
    ...
    if (produk == null) {
        response.sendRedirect(ctx + "/seller/produk");
        return;
    }

    String nama = produk.getNama() != null ? produk.getNama() : "";
    String deskripsi = produk.getDeskripsi() != null ? produk.getDeskripsi() : "";
    String kategori = produk.getKategori() != null ? produk.getKategori() : "Lainnya";
...
<html lang="id">
    <head>
        ...
        <title>Edit Produk - EpStore</title>
            ...
            <div class="seller-content">
                ...
                <main class="dashboard-main">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <h1 class="dashboard-title mb-0">Edit Produk</h1>
                    </div>

                    <!-- Form Card -->
                    <div class="card table-card mt-0" style="max-width: 900px;">
                        <div class="table-card-header">
                            <h2 class="table-card-title"><i class="bi bi-pencil-square me-2 text-success" style="color: #137333 !important;"></i>Ubah Informasi Produk</h2>
                        </div>
                        <div class="table-card-body p-4">
                            ...
                            <form action="<%= ctx%>/seller/produk/edit" method="POST" id="editProdukForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 ps-md-4 text-start">
                                        <label for="gambarFile" class="form-label fw-bold text-dark mb-3">Gambar Produk <span class="text-muted" style="font-size: 0.8rem; font-weight: normal;">(Kosongkan jika tidak ingin diubah)</span></label>

                                        <input type="file" class="form-control mb-4" id="gambarFile" name="gambarFile" accept="image/*">

                                        <!-- Selected Preview -->
                                        <% boolean hasImage = (gambar != null && !gambar.trim().isEmpty());%>
                                        <div class="card bg-light border p-3 text-center mb-4" id="previewContainer" style="display: <%= hasImage ? "block" : "none"%>;">
                                            ...
                                            <div class="mx-auto rounded border bg-white overflow-hidden d-flex align-items-center justify-content-center" style="width: 120px; height: 120px;">
                                                <img id="imagePreview" src="<%= hasImage ? ctx + "/" + gambar : ""%>" alt="Preview" class="w-100 h-100 object-fit-cover">
                                            </div>
                                        </div>
                                    </div>
                                </div>
